...
class SwinIR(nn.Module):
    ...
    def __init__(self, img_size=64, patch_size=1, in_chans=3,
        ...
        self.self_attention = SelfAttention(256)  # ViT 出来的是 256x64x64， RSTB 出来的是 64x64x64 64是 Embed Dim
        self.adapt_conv = nn.Conv2d(1280, 256, kernel_size=1) # ViT 用的是 1280x64x64 需要降维到 64x64x64
    ...
    def forward_features(self, x):
        ...
        for layer in self.layers:
            ...
            x = self.patch_unembed(x, x_size) # torch.Size([1, 256, 64, 64])
...
if __name__ == '__main__':
    ...
    model = SwinIR(upscale=4, img_size=(height, width),
                   ...
                   embed_dim=256, num_heads=[8, 8, 8, 8], mlp_ratio=2, upsampler='pixelshuffledirect', y_adapt_feature=torch.randn(1, 1280, 64, 64))

...
class SwinIRPixelShuffel(nn.Module):
    r""" SwinIR
    ...
    def __init__(self, img_size=64, patch_size=1, in_chans=3,
                 ...
                 **kwargs):
        super(SwinIRPixelShuffel, self).__init__()
        num_in_ch = in_chans
        num_out_ch = in_chans
        num_feat = 64
...
if __name__ == '__main__':
    ...
    model = SwinIRPixelShuffel(upscale=2, img_size=(48, 48), window_size=8, 
                          img_range=1., depths=[6,6,6,6,6,6], embed_dim=180, 
                          num_heads=[6,6,6,6,6,6], mlp_ratio=2, upsampler='pixelshuffle', y_adapt_feature=y_adapt_feature)
